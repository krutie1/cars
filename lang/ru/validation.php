...
return [
    ...
    'ascii' =>
        'Значение поля :attribute должно содержать только однобайтовые цифро-буквенные символы.',
    ...
    'doesnt_end_with' =>
        'Значение поля :attribute не должно заканчиваться одним из следующих: :values.',
    'doesnt_start_with' =>
        'Значение поля :attribute не должно начинаться с одного из следующих: :values.',
    ...
    'missing_unless' =>
        'Значение поля :attribute должно отсутствовать, когда :other не равно :value.',
    'missing_with' => 'Значение поля :attribute должно отсутствовать, если :values указано.',
    'missing_with_all' =>
        'Значение поля :attribute должно отсутствовать, когда указаны все :values.',
    ...
    'current_password_not_valid' => 'Неверно указан :attribute.',
    'latitude' => 'Значение поля :attribute должно быть корректной широтой',
    'longitude' => 'Значение поля :attribute должно быть корректной долготой',
    'phone' => 'Значение поля :attribute имеет некорректный формат',
    'upload_empty_type' => 'Загруженный файл уже привязан к другому объекту',
    'intersect' => 'Значение поля :attribute не должны пересекаться с :other',
    ...
    */
    'attributes' => [
        ...
        'year' => 'год',
        'quiz' => [
            'title_ru' => 'Название теста на русском',
            'title_kk' => 'Название теста на казахском',
        ],
        'password_current' => 'Текущий пароль',
        'lat' => 'широта',
        'lng' => 'долгота',
        'pit_image_ids' => 'Фото местности',
        'pit_location_image_ids' => 'Фото ям',
    ],
    ...
    */
    'custom' => [
        ...
        'pit_image_ids.*' => [
            'exists' => 'Загруженный файл не найден',
            'IntersectRule' => 'Картинки не должны пересекаться в полях',
        ],
        'pit_location_image_ids.*' => [
            'exists' => 'Загруженный файл не найден',
        ],
    ],
];
